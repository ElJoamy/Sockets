...
//							//JOptionPane.showMessageDialog(null, "No Name of the online users matches this name : "+ data[3] +"\n Check the online users correctly ", "This user is not found or not online", JOptionPane.ERROR_MESSAGE);
    ...
    private void initComponents() {
        ...
        b_start.setFont(new Font("Tahoma", Font.ITALIC, 14));
        b_start.setBackground(Color.yellow);
        b_end = new javax.swing.JButton();
        b_end.setFont(new Font("Tahoma", Font.ITALIC, 14));
        b_end.setBackground(Color.yellow);
        b_users = new javax.swing.JButton();
        b_users.setFont(new Font("Tahoma", Font.ITALIC, 14));
        b_users.setBackground(Color.yellow);
        b_clear = new javax.swing.JButton();
        b_clear.setFont(new Font("Tahoma", Font.ITALIC, 14));
...
//		//JOptionPane.showMessageDialog(null, "No Name of the online users matches this name : "+ data[3] +"\n Check the online users correctly ", "This user is not found or not online", JOptionPane.ERROR_MESSAGE);
    ...
    public void changetxtareafontsize(JTextArea txtarea){
    	Font font1 = new Font("SansSerif", Font.ITALIC, 14);
